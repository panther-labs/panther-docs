...
5. Enter the Bucket details:
   * **Source Name**: Enter a memorable name for the S3 source.
   * **AWS Account ID**: Enter the 12-digit AWS Account ID where the S3 buckets are located.
   * **AWS Bucket Name**: Enter the S3 Bucket ID/name to onboard.
   * **KMS Key (optional)**: If your data is encrypted using KMS-SSE, provide the ARN of the KMS key.
   * **Logs Stream Type**: Select the format of the logs this source is going to receive. If you are not sure, you can leave it as the default option (Lines). If an incorrect stream type is chosen, Panther will trigger a system error alert.
   * **S3 Prefixes & Schemas**: Define a prefix or schema to tell Panther which folders to include in the event that your S3 bucket contains multiple data sources. Select the "later" option if you want to set this up at a later time.
...
![The "Setup an IAM role" page in the Panther Console displays the options for setting up the IAM role.](<../../.gitbook/assets/Screen Shot 2022-06-24 at 9.37.53 AM.png>)
...
3. Select **Create Stack** (with new resources).\
   ![](<../../../../.gitbook/assets/setup-sns1 (12) (1) (1) (11) (1) (1) (1) (10) (13).png>)\
...
4.  Under the "Specify template" section, enter the following Amazon S3 URL:\
    ...
    \
    ![](<../../../../.gitbook/assets/setup-sns2 (11) (1) (1) (11) (1) (1) (1) (10) (13).png>)\
