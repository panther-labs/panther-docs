...
5. Specify the following stack details:
   ...
   4. `SnsTopicName:` The name of the SNS topic receiving the notification, by default this is `panther-notifications-topic`
6. Click on **Next**, **Next**, and then **Create Stack** to complete the process.&#x20;
