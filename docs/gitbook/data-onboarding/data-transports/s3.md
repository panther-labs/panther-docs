...
* ****[**Using the AWS Console UI**](https://docs.runpanther.io/data-onboarding/data-transports/s3#creating-an-iam-role-using-aws-console-ui): Launch a CloudFormation stack using the AWS console.&#x20;
* ****[**CloudFormation Template File**](https://docs.runpanther.io/data-onboarding/data-transports/s3#creating-an-iam-role-using-cloudformation-template-file): Use Panther's provided CloudFormation templates to create an IAM role by downloading the CloudFormation template.&#x20;
* ****[**I want to set up everything on my own**](https://docs.runpanther.io/data-onboarding/data-transports/s3#creating-an-iam-role-manually-or-with-other-automation): Create the role yourself and fill in the role ARN in Panther.
...
Click **Finish Setup** to complete this process, or configure a log drop-off alarm before you finish the setup.
...
3. Select **Create Stack** (with new resources).\
   ![](<../../../../.gitbook/assets/setup-sns1 (12) (1) (1) (11) (13).png>)\
...
4.  Under the "Specify template" section, enter the following Amazon S3 URL:\
    ...
    \
    ![](<../../../../.gitbook/assets/setup-sns2 (11) (1) (1) (11) (13).png>)\
...
Once the S3 bucket has been successfully onboarded to Panther and data is flowing, Panther will backup all raw logs for up to 30 days. After 30 days, the logs will be deleted.&#x20;
