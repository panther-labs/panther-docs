...
| **`action`** | `string` | The action performed. See [https://api.slack.com/enterprise/audit-logs\#audit\_logs\_actions](https://api.slack.com/enterprise/audit-logs#audit_logs_actions) |
