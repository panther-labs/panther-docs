...
`{version}` is latest Panther version, e.g. v1.22.1
...
An example of a full link to the set of tools would be: [https://panther-community-us-east-1.s3.amazonaws.com/v1.22.1/tools/darwin-amd64.zip](https://panther-community-us-east-1.s3.amazonaws.com/v1.22.1/tools/darwin-amd64.zip)
