...
`{version}` is latest Panther version, e.g. v1.17.1
...
An example of a full link to a devtool would be [https://panther-community-us-east-1.s3.amazonaws.com/v1.17.1/tools/dev/pantherlog-darwin-amd64](https://panther-community-us-east-1.s3.amazonaws.com/v1.17.1/tools/dev/pantherlog-darwin-amd64)
