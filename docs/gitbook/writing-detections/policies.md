...
![Policy Editor](<../../../.gitbook/assets/policy-creation1 (5) (1) (1) (1) (2).png>)

### Set Attributes

Keeping with the Password Policy example above, set all the necessary rule attributes:

![Attributes Set](<../../../.gitbook/assets/policy-creation2 (6) (1) (1) (1) (2).png>)

### Write Policy Body

Then write our policy logic in the `policy()` function.

![Policy Body](<../../../.gitbook/assets/policy-creation3 (7) (1) (1) (1) (3).png>)

### Configure Tests

Next, configure test cases to ensure our policy works as expected:

![Unit Tests](<../../../.gitbook/assets/policy-creation4 (7) (2) (1) (1) (1) (7).png>)
